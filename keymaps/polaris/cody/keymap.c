...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all( /* Base */
    ...
    KC_ESC,   KC_LGUI, KC_LALT,          KC_LSFT,          MO(1),            KC_SPC,                    KC_RALT, KC_ESC,  KC_APP, KC_RCTL
  ),
  [_FN] = LAYOUT_all( /* FN */
    ...
    _______, _______, _______, _______, _______, DM_REC1, DM_RSTP, DM_PLY1, _______, _______, _______, _______,          _______, _______,
