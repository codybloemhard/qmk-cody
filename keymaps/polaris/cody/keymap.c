...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all( /* Base */
    ...
    KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,         HMDIR,
    KC_LGUI,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                  KC_ENT,
    KC_LCTL,  _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_CAPS,XXXXXXX,
    KC_ESC,   KC_LGUI, KC_LALT,          MT(MOD_LSFT, KC_BSPC),     MO(1),            KC_SPC,           KC_RALT, KC_ESC,  KC_APP, KC_RCTL
  ),
  [_FN] = LAYOUT_all( /* FN */
    ...
    KC_LSFT, _______, _______, _______, _______, DM_REC1, DM_RSTP, DM_PLY1, KC_ESC,  _______, _______, _______,          _______, _______,
