...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_all( /* Base */
    ...
    LT(L_MOUSE, KC_TAB),        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          HMDIR,
    MT(MOD_LGUI, KC_ENT),       KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,                   KC_ESC,
    MT(MOD_LCTL, KC_BSPC),      _______, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_CAPS, LROTATE,
    KC_LCTL,                    KC_LGUI, KC_LALT,          KC_LSFT,          LT(L_FN, KC_ESC), KC_SPC,                    KC_RALT, KC_ENT,  KC_APP,  KC_RCTL
  ),
