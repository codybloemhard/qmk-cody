...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_BASE_STD] = KEYMAP(
        K_TAB, KC_Q, KC_G, KC_M, KC_L, KC_W, KC_Y,    KC_F, KC_U, KC_B,    KC_SCLN, KC_EQL,
        K_CAP, KC_D, KC_S, KC_T, HN_U, KC_R, KC_I,    HA_U, HE_D, KC_O,    KC_H,    KC_QUOT,
        K_SHF, KC_Z, KC_X, KC_C, KC_V, KC_J, KC_BSLS, KC_K, KC_P, KC_COMM, KC_DOT,  KC_SLSH,
    ...
    [L_BASE_GAME] = KEYMAP(
        ...
        KC_ENT, KC_SPC, MT(MOD_LGUI, KC_ESC), K_RFN, KC_SPC, MO(L_BLS)
    ),
    ...
    [L_DOWN] = KEYMAP(
        _______, _______, KC_RBRC, KC_RCBR, KC_RPRN, KC_EQL,  _______, _______, _______, _______, _______, _______,
        _______, HMDIR,   KC_LBRC, KC_LCBR, KC_LPRN, KC_PLUS, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,                   _______, _______, _______, _______, _______
    ),
    [L_FN] = KEYMAP(
        QK_BOOT, _______, _______, KC_PGUP, _______, _______, _______, KC_BSPC, KC_UP,   KC_DEL,  _______, _______,
        _______, KC_F1,   KC_HOME, KC_PGDN, KC_END,  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
