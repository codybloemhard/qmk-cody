...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_UP] = KEYMAP(
        _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR,  KC_GRV,  KC_TILD, KC_BSPC,
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,     KC_9,    KC_0,    _______,
        _______, KC_LBRC, KC_LCBR, KC_LPRN, KC_BSLS, KC_PIPE, _______, KC_RPRN,  KC_RCBR, KC_RBRC, _______, _______,
